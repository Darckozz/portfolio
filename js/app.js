...
const projectCards = document.querySelectorAll('.project-card'); // Capturé une seule fois proprement
...
// --- Écouteurs d'Événements Globaux Fixes ---
...
// Correction majeure de la liaison : on écoute TOUTES les cartes en même temps dès le départ
...
// --- Gestion Stable du Changement d'Onglets Badges ---
document.addEventListener('DOMContentLoaded', () => {
    ...
    tabButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            // 1. Mettre à jour l'apparence du badge cliqué
            ...
            // 2. Basculer les affichages des containers
